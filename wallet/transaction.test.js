...
describe("Transaction", () => {
  let transaction;
  //only wallets will be able to create this transactions, so:
  let senderWallet;
  //the transaction will have a recipient
  let recipient;
  //and an amount
  let amount;
  beforeEach(() => {
  ...
  describe("outputMap", () => {
    ...
    it("outputs the remainder balance for the `senderWallet`", () => {
  ...
  describe("input", () => {
    ...
    it("sets the `address` to the `senderWallet` publicKet", () => {
